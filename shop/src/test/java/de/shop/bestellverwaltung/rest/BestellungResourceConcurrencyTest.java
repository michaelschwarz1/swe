...
public class BestellungResourceConcurrencyTest extends AbstractResourceTest {
		...
		private static final Long BESTELLUNG_ID_UPDATE = Long.valueOf(102);
		private static final int NEUE_ANZAHL = 5;
		private static final int NEUE_ANZAHL2 = 500;
		...
		public void updateUpdate() throws InterruptedException, ExecutionException {
			...
			final int neueAnzahl1 = NEUE_ANZAHL;
			final int neueAnzahl2 = NEUE_ANZAHL2;
